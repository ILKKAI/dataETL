...
def data_shuffle(data):
    ...
    if not data.get("YEAR_"):
        ...
        if year:
            data["YEAR_"] = year[0]
    data['NOTICE_TIME_'] = data['NOTICE_TIME_'][1:]
    data["FILE_URL_"] = data["PDF_URL_"]
    data["FILE_NAME_"] = data["PDF_NAME_"][:-4]
    return data


if __name__ == '__main__':
    main_mongo = MongoClient(entity_code="XYK_YJBG_ZGGSYH", mongo_collection="XYK_YJBG")
