...
DEFAULT_LOG_DIR = "."
# datashufflepy 项目日志
DEFAULT_LOG_FILENAME = DEFAULT_LOG_DIR + "/datashufflepy/" + rq + ".log"
# DEFAULT_LOG_FILENAME = "/home/ijep/logs/python/datashufflepy_cha/" + rq + ".log"
...
class Logger(object):
    ...
    def _get_file_handler(self, filename):
        try:
            ...
            os.mkdir(DEFAULT_LOG_DIR + "/datashufflepy")
            filehandler = logging.FileHandler(filename=filename, encoding="utf-8")
