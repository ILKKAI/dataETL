# -*- coding: utf-8 -*-
"""CRMJPFX_ZXYQ_ZGMYJRW_YH   中国贸易金融网-银行"""
import jsonpath
...
def data_shuffle(data, ):
    ...
    re_data['NEWS_DATA_RESOURCES'] = data.get('SOURCE_')
...
if __name__ == '__main__':
    main_mongo = MongoClient(entity_code="CRMJPFX_ZXYQ_ZGMYJRW_YH", mongo_collection="CRMJPFX_ZXYQ")
