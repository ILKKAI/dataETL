...
def data_shuffle(data, province_list, city_list, area_list):
    ...
    re_data["UNIT_CODE_"] = re_data["BANK_CODE_"] + "_" + re_data.get("CITY_CODE_", "")
...
if __name__ == '__main__':
    ...
    main_mongo = MongoClient(entity_code="CRMJPFX_WD_KBB_ALL", mongo_collection="CRMJPFX_WD")
