...
def data_shuffle(data, province_list, city_list, area_list):
    ...
    if  '巢湖' in data['CITY_NAME_'] or '巢湖' in data['AREA_NAME_']:
        re_data["PROVINCE_NAME_"] = '安徽省'
        re_data["PROVINCE_CODE_"] = '3400'
        re_data['CITY_NAME_'] = '巢湖市'
        re_data['CITY_CODE_'] = '340181'
        area_n = ''
        area_c = ''
    ...
    re_data["UNIT_CODE_"] = "CIB" + "_" + re_data.get("CITY_CODE_", "")
...
if __name__ == '__main__':
    ...
    main_mongo = MongoClient(entity_code="CRMJPFX_WD_XYYH", mongo_collection="CRMJPFX_WD")
