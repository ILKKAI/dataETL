...
def data_shuffle(data, province_list, city_list, area_list):
    ...
    re_data["UNIT_CODE_"] = "CITIC" + "_" + re_data.get("CITY_CODE_", "")
...
if __name__ == '__main__':
    ...
    main_mongo = MongoClient(entity_code="CRMJPFX_WD_ZXYH", mongo_collection="CRMJPFX_WD")
