...
def data_shuffle(data, province_list, city_list, area_list):
    ...
    # 先处理省市区, 经纬度
    ##############
    branch_name = data.get('BRANCH_NAME_')[:-2]
    ...
    # "C"
    re_data["BANK_CODE_"] = "BOB"
    re_data["BANK_NAME_"] = "北京银行"
    ...
    re_data["UNIT_CODE_"] = "BOB" + "_" + re_data.get("CITY_CODE_", "")
...
if __name__ == '__main__':
    ...
    main_mongo = MongoClient(entity_code="CRMJPFX_WD_BJYH", mongo_collection="CRMJPFX_WD")
