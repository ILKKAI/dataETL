...
def data_shuffle(data, province_list, city_list, area_list):
    ...
    re_data["ID_"] = data["ENTITY_CODE_"] + "_" + str(
        9999999999 - int(float(data["DEALTIME_"]))) + "_" + str(hash_title)
...
def run():
    script = GenericScript(entity_code="PABORGANIZE", entity_type="ORGANIZE_FINASSIST")
