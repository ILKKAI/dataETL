...
def data_shuffle(mongo_data_list):
    ...
    for data in mongo_data_list:
        ...
        elif "中新网" in data["CONTENT_"]:
            re_data["DATA_SOURCE_"] = "中新网"
        elif "中新社" in data["CONTENT_"]:
            re_data["DATA_SOURCE_"] = "中国新闻网"
...
def run():
    ...
    script = GenericScript(entity_code="NEWS10JQKA", entity_type="NEWS_FINASSIST")
    ...
    # pd.DataFrame(data_list).to_csv('E:\\NEWS_CLEAN_\\NEWS10JQKA.csv', encoding="utf_8_sig")
    # print("文件导出成功")
