...
#  徽商银行 ZTB_HSYH
#  无 CONTENT_
# http://rczp.hsbank.com.cn:8000/cggl/modules/pur/PUR4040/pur_bid_announcement_context.screen?title_id=2901
...
def run():
    main_mongo = MongoClient(entity_code="ZTB_HSYH", mongo_collection="CommonBidding")
