# -*- coding: utf-8 -*-
# 5 条 ['340000AHRCU.CONTENT.NOTICE_TIME_', '2017-07-03'] 可父级[2018-11-27]
# 安徽省农村信用社联合社网站 340000AHRCU
# 无中标结果
import re
import time
...
def run():
    script = GenericScript(entity_code="340000AHRCU", entity_type="CommonBidding")
