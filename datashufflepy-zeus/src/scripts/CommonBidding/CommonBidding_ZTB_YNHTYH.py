...
#  云南红塔银行-招投标网站 ZTB_YNHTYH
#  PDF
# http://www.ynhtbank.com/ynhtyh/resource/cms/article/sub295208/397626/2019070413595224914.pdf
...
def run():
    main_mongo = MongoClient(entity_code="ZTB_YNHTYH", mongo_collection="CommonBidding")
