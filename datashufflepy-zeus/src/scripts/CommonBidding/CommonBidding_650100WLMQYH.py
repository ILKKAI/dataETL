...
# 乌鲁木齐银行网站 650100WLMQYH

# 1823  没有 WIN_CANDIDATE_ 字段 已完成

# 有NOTICE_TIME_ ， 但是格式有问题：['650100WLMQYH.CONTENT.NOTICE_TIME_', '2016-11-22']
...
def data_shuffle(data):
    ...
    if not result:
        result = re.findall(r"投?标?单位名称\|1\|(\w*[(（《]?\w*[)）》]?\w*)", data["CONTENT_"])
...
def run():
    script = GenericScript(entity_code="650100WLMQYH", entity_type="CommonBidding")
