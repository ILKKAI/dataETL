...
#  中国招标投标公共服务平台 ZGZBTBGGFWPT

#  无 CONTENT_
# http://bulletin.cebpubservice.com/biddingBulletin/2019-07-31/1691684.html
...
def run():
    main_mongo = MongoClient(entity_code="ZGZBTBGGFWPT", mongo_collection="CommonBidding")
