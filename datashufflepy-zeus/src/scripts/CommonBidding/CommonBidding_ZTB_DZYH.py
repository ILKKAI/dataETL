...
#  doc 文件
# http://www.dzbchina.com/res/jrfcms_mobi/userFiles/zhglbmadmin/file/201907301436052745631.docx
...
def run():
    main_mongo = MongoClient(entity_code="ZTB_DZYH", mongo_collection="CommonBidding")
