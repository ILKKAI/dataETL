...
# 昆仑银行网站 110000KLYH
# 4 条 ['110000KLYH.CONTENT.NOTICE_TIME_', '2016-09-21'] 父级为 06/12
# 无 WIN_CANDIDATE_ 字段 无中标公告  342
import re
import time
...
def run():
    script = GenericScript(entity_code="110000KLYH", entity_type="CommonBidding")
