...
def data_shuffle(data, list_SUBS_STATUS, list_TYPE):
    ...
    # 人气值
    re_data["POPULARITY_"] = data["POPULARITY_"]
    # 银河三年评级
    re_data["RATING_"] = data["RATING_"]
    # 单位净值（日万份收益）
    ...
    # 月涨跌
    re_data["MONTH_RATE_"] = data["MONTH_RATE_"]
    #近三月
    re_data["QUARTER_RATE_"] = data["QUARTER_RATE_"]
    # 近六月
    re_data["HALF_YEAR_RATE_"] = data["HALF_YEAR_RATE_"]
    #近一年
    re_data["YEAR_REWARD_"] = data["YEAR_REWARD_"]
    # 成立至今
    re_data["HISTORY_RATE_"] = data["HISTORY_RATE_"]
    # 基金公司
...
def run():
    ...
    script = GenericScript(entity_code="CCBFUND", entity_type="JSFUND_CCBDATA")
