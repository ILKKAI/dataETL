...
# 交通银行理财产品 BOCOMFinancial
# 无 CONTENT_  已完成
# 无 开始售卖时间， 结束售卖时间，售卖时间范围, 产品期限， 可否赎回， 是否保本
# 原网页打不开
...
def data_shuffle(data):
    ...
    re_data["ID_"] = "BOCOM" + "_" + data["CODE_"]
...
def run():
    script = GenericScript(entity_code="BOCOMFinancial", entity_type="FINPRODUCT_FINASSIST")
