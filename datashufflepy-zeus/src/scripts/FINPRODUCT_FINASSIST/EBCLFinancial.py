...
# 恒丰银行理财产品 EBCLFinancial

# 无 CONTENT_ 已完成

# 售卖时间范围  可否赎回  私人银行
# 起购金额 存入字段为 xml（12-15 前）
...
def data_shuffle(data):
    ...
    re_data["ID_"] = "EBCL" + "_" + data["CODE_"] + "_" + start_time[0]
    re_data["ENTITY_CODE_"] = data["ENTITY_CODE_"]
    # re_data["AREA_CODE_"]
    re_data["BANK_CODE_"] = "EBCL"
    re_data["BANK_NAME_"] = "恒丰银行"
    # re_data["UNIT_CODE_"]
...
def run():
    script = GenericScript(entity_code="EBCLFinancial", entity_type="FINPRODUCT_FINASSIST")
