...
class BranchNews(GenericScript):
    ...
    def generic_shuffle(self, data):
        ...
        house_id = self.if_exists(name=verify_name, city_name="北京市")
        ...
        if house_id:
            ...
            basic_dict["PROVINCE_CODE_"] = "1100"
            basic_dict["PROVINCE_NAME_"] = "北京市"
            basic_dict["CITY_CODE_"] = "110100"
            basic_dict["CITY_NAME_"] = "北京市"
...
if __name__ == '__main__':
    ...
    script = BranchNews(table_name=TABLE_NAME("CHA_BRANCH_HOUSE_DATA"), collection_name="WD_JZ_FJ_BJ", param=param)
    script.main()
    script.close_client()
