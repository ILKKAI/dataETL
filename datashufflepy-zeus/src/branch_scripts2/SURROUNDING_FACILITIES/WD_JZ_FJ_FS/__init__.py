...
class BranchNews(GenericScript):
    ...
    def generic_shuffle(self, data):
        ...
        house_id = self.if_exists(name=verify_name, city_name="佛山市")
        ...
        if house_id:
            ...
            #################           重点需修改        ####################
            basic_dict["PROVINCE_CODE_"] = "4400"
            basic_dict["PROVINCE_NAME_"] = "广东省"
            basic_dict["CITY_CODE_"] = "440600"
            basic_dict["CITY_NAME_"] = "佛山市"
