...
class BranchNews(GenericScript):
    ...
    def generic_shuffle(self, data):
        ...
        house_id = self.if_exists(name=verify_name, city_name="成都市")
        ...
        if house_id:
            ...
            basic_dict["PROVINCE_CODE_"] = "5100"
            basic_dict["PROVINCE_NAME_"] = "四川省"
            basic_dict["CITY_CODE_"] = "510100"
            basic_dict["CITY_NAME_"] = "成都市"
...
if __name__ == '__main__':
    ...
    script = BranchNews(table_name=TABLE_NAME("CHA_BRANCH_HOUSE_DATA"), collection_name="WD_JZ_FJ_CD", param=param)
    script.main()
    script.close_client()
