...
def data_shuffle(data, province_list, city_list, area_list):
        ...
        try:
            ...
            for prov in province_list:
                if prov["CODE_"] == re_data["PROVINCE_CODE_"]:
                    re_data["PROVINCE_NAME_"] = prov["NAME_"]
                    break
    re_data["UNIT_CODE_"] = "CCB" + "_" + re_data.get("CITY_CODE_", "")
    ...
    # re_data["BUSINESS_HOURS_"] = data["BUSINESS_HOURS_BEGIN_"] + data["BUSINESS_HOURS_END_"]
...
if __name__ == '__main__':
    main_mongo = MongoClient(entity_code="CCBORGANIZE2", mongo_collection="WD_TY")
    sc = GenericScript
    # Mysql connection
