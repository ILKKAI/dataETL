# -*- coding: utf-8 -*-
"""21世纪经济网-新时代  ZX_CJXW_ZYCJ_21SJJJW_XSD"""
import re
...
def data_shuffle(data):
    ...
    # re_data = dict()
    #
    # # split_content = data["CONTENT_"].split("|")
    #
...
if __name__ == '__main__':
    main_mongo = MongoClient(entity_code="ZX_CJXW_ZYCJ_21SJJJW_XSD", mongo_collection="ZX_CJXW_ZYCJ")
